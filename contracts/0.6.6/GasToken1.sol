...
contract GasToken1 {
    ...
    uint256 STORAGE_LOCATION_ARRAY = 0xDEADBEEF;
    ...
    function mint(uint256 value) public {
        uint256 storage_location_array = STORAGE_LOCATION_ARRAY;  // can't use views inside assembly
